...
- See the number of patients ahead
- Track queue history
...
- Easy-to-understand queue status
...
### Home Page
The home screen provides access to the main healthcare services and queue information.
### Hospital Services
Users can view available services such as doctor consultation, laboratory, pharmacy, and registration.
### Queue History
Users can review their previous queue activities.
### Alert Page
Users receive important updates related to their queue and waiting time.
### Profile
